...
class UnopenedScopeError(SyntaxError):
    def __init__(self, pos_start, pos_end, details=''):
        super().__init__(pos_start, pos_end, 'UnopenedScopeError', details)
...
class InvalidOperationTokenError(SyntaxError):
    def __init__(self, pos_start, pos_end, details=''):
        super().__init__(pos_start, pos_end, 'InvalidOperationTokenError', details)


class ModuleImportError(SyntaxError):
    def __init__(self, pos_start, pos_end, details=''):
        super().__init__(pos_start, pos_end, 'ModuleImportError', details)


class ModuleNotFoundError(SyntaxError):
    def __init__(self, pos_start, pos_end, details=''):
        super().__init__(pos_start, pos_end, 'ModuleNotFoundError', details)


class PrematureEOFError(SyntaxError):
    def __init__(self, pos_start, pos_end, details):
        super().__init__(pos_start, pos_end, 'PrematureEOFError', details)
...
class InvalidArgumentSetError(RuntimeError):
    def __init__(self, pos_start, pos_end, details, context):
